...
#   DMG_BACKGROUND_PATH    default: apps/macos/Sources/OpenClaw/Resources/dmg/dmg-background.png
#   DMG_BACKGROUND_SMALL   default: apps/macos/Sources/OpenClaw/Resources/dmg/dmg-background-small.png (recommended)
...
DMG_BACKGROUND_SMALL="${DMG_BACKGROUND_SMALL:-$ROOT_DIR/apps/macos/Sources/OpenClaw/Resources/dmg/dmg-background-small.png}"
DMG_BACKGROUND_PATH="${DMG_BACKGROUND_PATH:-$ROOT_DIR/apps/macos/Sources/OpenClaw/Resources/dmg/dmg-background.png}"
